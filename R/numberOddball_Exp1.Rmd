...
top_folder = '/Users/kohler/Google Drive/WRITING/Articles/2019_KohlerNumerositySSVEP/figures/results/experiment1'
counter = 0
for (f in c(1,2,3)) {
  for (q in c(1,2,3,4)) {
    ...
    write.csv(as.matrix(anova(m1)), 
              file = sprintf('%s/%s%d_full_projected_all_results.csv', top_folder, cur_file, f), 
              na ="")
